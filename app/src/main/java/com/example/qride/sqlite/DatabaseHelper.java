...
>>>>>>> 14d0b7d47123eeb823e1239f116e7838bfdc55a4
    ...
    private void insertSampleData(SQLiteDatabase db) {
        ...
        // Chèn thông báo mẫu
        db.execSQL("INSERT INTO notifications (title, message, timestamp, type) VALUES ('Chào mừng', 'Chào mừng bạn đến với Q-Ride!', '2023-10-27 10:00', 'GENERAL')");
        db.execSQL("INSERT INTO notifications (title, message, timestamp, type) VALUES ('Ưu đãi mới', 'Bạn nhận được voucher giảm 50% cho chuyến đi đầu tiên.', '2023-10-27 10:05', 'VOUCHER')");
    }
